        ...
        <form action="controller" method="get">
            ...
            <div class="form_wrapper">
                ...
                <div id="form_left" class="form_block">
                    ...
                    <button onclick="setX(-5)" type="button" id="x_button_-5">-5</button>
                    <button onclick="setX(-4)" type="button" id="x_button_-4">-4</button>
                    <button onclick="setX(-3)" type="button" id="x_button_-3">-3</button>
                    <button onclick="setX(-2)" type="button" id="x_button_-2">-2</button>
                    <button onclick="setX(-1)" type="button" id="x_button_-1">-1</button>
                    <button onclick="setX(0)" type="button" id="x_button_0">0</button>
                    <button onclick="setX(1)" type="button" id="x_button_1">1</button>
                    <button onclick="setX(2)" type="button" id="x_button_2">2</button>
                    <button onclick="setX(3)" type="button" id="x_button_3">3</button>
